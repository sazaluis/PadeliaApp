...
import { ClipboardList, Plus, CheckCircle, Clock, XCircle, Calendar as CalendarIcon, Pencil, Send, Trash2, Users, UserCheck, Loader2, UserPlus } from "lucide-react";
...
export default function ConvocationsPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "ENVIADA": return <Badge variant="outline">Enviada</Badge>;
                ...
                <Card key={conv.id}>
                  ...
                  <CardContent>
                    <div className="flex items-center gap-2 text-sm text-muted-foreground mb-3">
                      ...
                      {passedDeadline && conv.status === "ENVIADA" && (
                        <span className="text-red-500">· Plazo vencido</span>
                      )}
                    </div>
